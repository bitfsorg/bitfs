...
func TestExitCodeFromError(t *testing.T) {
	tests := []struct {
		...
		{"NotFound", client.ErrNotFound, ExitNotFound},
		{"Timeout", client.ErrTimeout, ExitNetError},
		{"Network", client.ErrNetwork, ExitNetError},
		{"Server", client.ErrServer, ExitNetError},
		{"PaymentRequired", client.ErrPaymentRequired, ExitPermError},
		{"GenericError", errors.New("something broke"), ExitError},
		{"WrappedNotFound", fmt.Errorf("context: %w", client.ErrNotFound), ExitNotFound},
		{"WrappedTimeout", fmt.Errorf("context: %w", client.ErrTimeout), ExitNetError},
		{"WrappedNetwork", fmt.Errorf("context: %w", client.ErrNetwork), ExitNetError},
		{"WrappedServer", fmt.Errorf("context: %w", client.ErrServer), ExitNetError},
		{"WrappedPayment", fmt.Errorf("context: %w", client.ErrPaymentRequired), ExitPermError},
	}
